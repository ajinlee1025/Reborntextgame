...
const EVENTS = {
    ...
    guardians: [
        ...
        },
        {
            ...
            text: '"EXTREME하다!! 이 복도에 EXTREME한 기운이 느껴진다!"\n복싱 글러브를 낀 백발의 청년이 힘차게 달려왔다. 사사가와 료헤이.\n그는 너를 발견하고 두 눈을 빛낸다.',
            weight: 5,
            minTick: 5,
            options: [
                {
                    text: '"EXTREME하게 살아남겠습니다!"',
                    effects: { hp: 20, reputation: { vongola: 15 } },
                    outcome: '"그래! 그 기세가 EXTREME해!!" 료헤이가 어깨를 탁 치더니 태양 불꽃으로 상처를 치유해줬다. HP +20, 본고레 평판 +15.'
                },
                {
                    text: '복싱 특훈을 부탁한다',
                    effects: { hp: -15, skills: { combat: 2 } },
                    outcome: '"EXTREME 특훈이다!!" 땀이 쏟아졌다. 하지만 분명히 강해졌다. 전투 +2 / HP -15.'
                },
                {
                    text: '조용히 지나친다',
                    effects: {},
                    outcome: '"EXTREME...?" 료헤이가 고개를 갸웃하더니 그냥 보내줬다.'
                }
            ]
        }
    ]
